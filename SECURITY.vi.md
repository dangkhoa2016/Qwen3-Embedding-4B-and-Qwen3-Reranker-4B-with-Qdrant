...
Public repository: https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant. Line `1.0.0` là first public release identity. Việc repository public không thay đổi yêu cầu phải báo unpatched vulnerability bằng kênh riêng.
