...
Cảm ơn bạn đã giúp cải thiện **Qwen3-Embedding-4B and Qwen3-Reranker-4B with Qdrant**.

Dự án được host tại https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant. Các hướng dẫn này áp dụng cho public repository và local review work của release line `1.0.0`.
