...
This file records the final pre-tag publication checkpoint for the first public release of `qwen3-embedding-4b-reranker-4b-qdrant`. Source is now published on the GitHub `main` branch; tag, GitHub Release, and package-index publication remain separate steps.
...
The public-facing audit added/refined `README.md`, PEP 639 package metadata, `SECURITY.md`, `CONTRIBUTING.md`, and `.github` issue/pull-request templates. After the repository was created at https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant, real project URLs were added to package metadata.
