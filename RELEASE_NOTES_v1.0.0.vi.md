...
**Git tag:** `v1.0.0`
Repository: https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant. Việc publish source trên GitHub, publish GitHub Release theo tag và publish lên package index là các kênh phát hành riêng, được kiểm chứng độc lập.
