...
from qwen3_qdrant.production_demo import (
    DemoConfig,
...
def test_hybrid_http_client_uses_existing_api_contract():
    import httpx
    from qwen3_qdrant.production_demo import HybridHttpClient
...
def test_qdrant_http_client_parses_query_api_points():
    import httpx
    from qwen3_qdrant.production_demo import QdrantHttpClient
