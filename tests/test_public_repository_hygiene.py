...
def test_public_package_metadata_is_pep639_ready_and_url_safe():
    ...
    assert project["urls"] == {
        "Homepage": "https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant",
        "Repository": "https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant",
        "Issues": "https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant/issues",
    }
...
def test_readme_is_a_complete_public_landing_page():
    ...
    assert "https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant" in text
...
def test_security_policy_is_private_report_first_and_repository_aware():
    ...
    assert "github.com/dangkhoa2016/qwen3-embedding-4b-reranker-4b-qdrant" in lower
