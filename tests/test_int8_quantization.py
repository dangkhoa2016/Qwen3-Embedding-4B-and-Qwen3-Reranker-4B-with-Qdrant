...
from qwen3_embedding_4b_and_qwen3_reranker_4b_with_qdrant.embedding_engine import EmbeddingEngine
from qwen3_embedding_4b_and_qwen3_reranker_4b_with_qdrant.reranker_engine import RerankerEngine
...
def test_embedding_int8_loader_uses_cpu_torchao_contract(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "qwen3_embedding_4b_and_qwen3_reranker_4b_with_qdrant.embedding_engine.build_torchao_quantization_config",
...
def test_reranker_int8_loader_preserves_yes_no_scoring(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "qwen3_embedding_4b_and_qwen3_reranker_4b_with_qdrant.reranker_engine.build_torchao_quantization_config",
        lambda mode: sentinel,
    )
...
def test_quantized_validator_fails_closed_without_quantized_weight_evidence():
    from qwen3_embedding_4b_and_qwen3_reranker_4b_with_qdrant.quantization import validate_quantized_cpu_model
