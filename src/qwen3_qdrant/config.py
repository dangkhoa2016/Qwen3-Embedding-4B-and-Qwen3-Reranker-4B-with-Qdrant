...
class Settings(BaseModel):
    service_name: str = "qwen3-embedding-4b-reranker-4b-qdrant"
    ...
    runtime_lock_path: Path = Path("/tmp/qwen3-embedding-4b-reranker-4b-qdrant.lock")
    ...
    def __init__(self, **data):
        env = {
            ...
            "runtime_lock_path": Path(os.getenv("RUNTIME_LOCK_PATH", "/tmp/qwen3-embedding-4b-reranker-4b-qdrant.lock")),
        }
