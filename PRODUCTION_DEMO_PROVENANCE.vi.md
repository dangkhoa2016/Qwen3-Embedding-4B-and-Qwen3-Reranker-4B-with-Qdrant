...
Approved first public package identity là `qwen3-embedding-4b-reranker-4b-qdrant==1.0.0`, author `Đăng Khoa <i.am@dangkhoa.dev>` theo MIT License. Internal import package vẫn là `qwen3_qdrant`; historical internal service/lock identifiers được chủ đích giữ lại trong protected qualified configuration.
