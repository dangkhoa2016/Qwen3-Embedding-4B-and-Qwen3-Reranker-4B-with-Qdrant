...
File này ghi lại final pre-tag publication checkpoint cho public release đầu tiên của `qwen3-embedding-4b-reranker-4b-qdrant`. Source hiện đã được publish trên branch GitHub `main`; tag, GitHub Release và package-index publication vẫn là các bước riêng.
...
REMOTE_REPOSITORY=https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant
GITHUB_REPOSITORY=https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant
...
Public-facing audit đã thêm/chỉnh `README.md`, PEP 639 package metadata, `SECURITY.md`, `CONTRIBUTING.md` và `.github` issue/pull-request templates. Sau khi repository được tạo tại https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant, các project URL thật đã được thêm vào package metadata.
