...
The public repository is https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant. The `1.0.0` line is the first public release identity. Public repository availability does not change the requirement to report unpatched vulnerabilities privately.
