...
This project is hosted at https://github.com/dangkhoa2016/Qwen3-Embedding-4B-and-Qwen3-Reranker-4B-with-Qdrant. These guidelines apply to the public repository and to local review work for the `1.0.0` release line.
